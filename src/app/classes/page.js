...
export default class Page {
  ...
  update () {
    ...
    // if (Math.abs(this.scroll.target - this.scroll.current) > this.scroll.step * 0.1) {
    //   this.scroll.current += (this.scroll.target - this.scroll.current) * this.scroll.step
    // }
    // // gsap.utils.interpolate(this.scroll.current, this.scroll.target, this.scroll.step)
    // if (this.children.wrapper) {
    //   this.children.wrapper.style.transform = `translate3d(0, ${this.scroll.current}px, 0)`
    // }
  }
